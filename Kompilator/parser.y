...
for_continue: 	TO identifier DO		{	FOR_3
							...
							FOR_4						}
		commands ENDFOR			{	FOR_5						}
	|	TO NUMBER DO			{	FOR_3
							create_number(code, $2, 2);
							create_number(code, 0, 0);
							STORE(2)
							FOR_4						}
		commands ENDFOR			{	FOR_5						}
	|	DOWNTO identifier DO		{	DOWNTO_FOR_3
							save_value_to_register(1, 1);
							DOWNTO_FOR_4
							FOR_4						}
		commands ENDFOR			{	DOWNTO_FOR_5					}
	|	DOWNTO NUMBER DO		{	DOWNTO_FOR_3
...
exp:	        NUMBER                          {       create_number(code, $1, 1);                     }
	...
	|	identifier PLUS NUMBER		{	save_adress_to_register(1, 0);
							create_number(code, $3, 1);
							ADD(1)						}
	|	NUMBER PLUS identifier		{	save_adress_to_register(1, 0);
							create_number(code, $1, 1);
							ADD(1)						}
	|	identifier PLUS identifier	{	save_value_to_register(1, 1);						
